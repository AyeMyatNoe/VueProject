...
const form = useForm({
    category: props.editCategory.category,
    photo: props.editCategory.photo,
    _method: "put",
});
const Update = () => {
    // console.log(form);
    form.transform((data) => ({
        ...data,
    })).post(route("category.update", props.editCategory.id));
};
</script>
<template>
    <button
                    ...
                    <div>
                        ...
                        <div class="mb-6">
                            <p
                                class="block text-gray-700 text-sm font-bold mb-2"
                            >
                                Category Photo<span class="text-red-800">*</span>
                            </p>
                            <label
                                for="file-upload"
